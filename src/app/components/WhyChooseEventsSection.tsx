...
export function WhyChooseEventsSection() {
  ...
  return (
    <section ref={containerRef} className="relative bg-[#111114] py-32 md:py-48 overflow-hidden">
      {/* Background Ambience */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/10 border-t border-b border-white/10">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="py-16 md:py-20 md:px-12 flex flex-col items-center md:items-start text-center md:text-left group"
            >
              <div 
