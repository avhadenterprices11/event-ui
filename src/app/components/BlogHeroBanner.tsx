  ...
  return (
    <section ref={containerRef} className="relative min-h-[60vh] md:min-h-[70vh] flex items-center justify-center overflow-hidden bg-[#0B0B0D]">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-20">
        <div className="absolute top-0 left-[20%] w-px h-full bg-gradient-to-b from-transparent via-[#C6A75E] to-transparent" />
        <div className="absolute top-0 right-[20%] w-px h-full bg-gradient-to-b from-transparent via-[#C6A75E] to-transparent" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-6 md:px-20 text-center flex flex-col items-center pt-24">
        ...
        <motion.p
          ...
          className="text-[#B8B8B8] max-w-2xl text-center text-sm md:text-base font-light leading-relaxed tracking-wide"
        >
          An exclusive look into the architecture of world-class celebrations. Expert planning guides, trending aesthetics, and stories from our most magnificent events.
        </motion.p>
      </div>
