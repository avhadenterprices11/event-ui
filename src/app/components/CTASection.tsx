...
export function CTASection() {
  ...
  return (
    <section ref={containerRef} className="py-0 bg-[#0B0B0D] relative">
      <div className="max-w-[1440px] mx-auto px-6 md:px-20 py-32 md:py-48">
        <div className="relative w-full rounded-[24px] overflow-hidden bg-[#111114]">
          ...
          <div className="relative z-10 px-8 py-24 md:py-32 flex flex-col items-center text-center">
             ...
             >
                ...
                <h2 
                   className="text-[48px] md:text-[72px] lg:text-[88px] text-[#F5F5F5] font-light leading-[1.05] tracking-tight mb-12"
                ...
                <Link
                  to="/quote"
                  className="group inline-flex items-center gap-4 bg-[#C6A75E] text-[#0B0B0D] px-10 py-5 rounded-full overflow-hidden relative shadow-[0_10px_40px_rgba(198,167,94,0.3)] transition-transform duration-500 hover:scale-105 hover:shadow-[0_10px_60px_rgba(198,167,94,0.5)]"
                >
