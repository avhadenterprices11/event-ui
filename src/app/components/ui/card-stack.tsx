    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ background: 'rgba(198, 167, 94, 0.05)' }}
          aria-hidden="true"
        />
        <div
              ...
              return (
                <motion.div
                  ...
                  style={{
                    ...
                    border: isActive 
                      ? '4px solid rgba(198, 167, 94, 0.4)' 
                      : '4px solid rgba(198, 167, 94, 0.15)',
                  }}
                  initial={
                    reduceMotion
                      ? false
...
function DefaultFanCard({ item, active }: { item: CardStackItem; active: boolean }) {
  return (
    <div className="relative h-full w-full">
      ...
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-[#0B0B0D] via-[#0B0B0D]/60 to-transparent" />

      {/* Gold accent overlay on active */}
      {active && (
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-[#C6A75E]/10 to-transparent" />
      )}

      {/* content */}
      <div className="relative z-10 flex h-full flex-col justify-end p-6">
        <div 
          className="truncate text-2xl mb-2"
          style={{ 
            color: '#F5F5F5',
